	...
	implements Puntal
{
  ...
  protected int compareToSameClass(Object other) {
    ...
    int result = getCoordinate().compareTo(point.getCoordinate());
    
    if(result == 0){
    	
    	Object obj = point.getUserData();
    	if (obj instanceof String){
    		result = ((String)obj).compareTo((String)((Point)other).getUserData());
    	} 
  ...
  public int hashCode()
  {
	  ...
	  int result = 17;
      result = 37 * result + Coordinate.hashCode(getX());
      result = 37 * result + Coordinate.hashCode(getY());
      result = 37 * result + this.getUserData().toString().hashCode();//Coordinate.hashCode(miny);
      return result;
  }
  ...
  public boolean equals(Object other)
  {
	  ...
	  boolean returnVal = this.equalsTopo(p);
	  if(returnVal == true){
		  if((int)p.getUserData() != (int)this.getUserData()){
			  returnVal = false;
		  }
	  }
	  return returnVal;
